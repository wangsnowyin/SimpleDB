...
public class HeapPage implements Page {
    ...
    */
    private int getNumTuples() {        
        ...
        int tupleSlots = (int) Math.floor((BufferPool.PAGE_SIZE*8.0) / (tupleSize * 8.0 + 1));
        return tupleSlots;
    ...
    private int getHeaderSize() {  
        int slots = this.getNumTuples();      
        int headerSize = (int) Math.ceil(slots / 8.0);
        return headerSize;
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        if(rid!=null){
            ...
            throw new DbException("No such record Id");
        }
    }
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        if(desc.equals(this.td)){
            ...
            throw new DbException("Mismatch tuple discription");
        }
    }
    ...
    public boolean isSlotUsed(int i) throws IllegalArgumentException {
        if(i<0 || (i/8)>=header.length) throw new IllegalArgumentException("Wrong slot");
    ...
    public Iterator<Tuple> iterator() {
        ...
        for(int i=0; i<tuples.length; i++){
        	if(isSlotUsed(i)) newTuples.add(tuples[i]);
        }
